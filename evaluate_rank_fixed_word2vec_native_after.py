...
def readCommandLineInput(argv):
    try:
        try:
            ...
            opts, _ = getopt.getopt(argv[1:], "hv:t:", ["help", "vectors=", "testvectors="])
...
if __name__ == "__main__":
    ...
    testVocab = consfit.selectTestVocab(vocab, commandParse[1])
    ...
    sys.stderr.write('phrase count is '+str(sum([1 for token in vocab if '|' in token]))+'\n')
