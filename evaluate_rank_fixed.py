...
help_message = '''
$ python evaluate_rank_fixed.py -v <vectorsFile> <-t testVectorFile> [-h]
...
if __name__ == "__main__":
    ...
    testVocab, testVectors, testVectorDim = consfit.readWordVectors(commandParse[1])
    vocab.update(testVocab)
    vectors.update(testVectors)
